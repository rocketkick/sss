...
public class Controller : MonoBehaviour {
	...
	void Start(){
		...
		/*
		Debug.Log(controlPath[0].GetType());
		GameObject a = GameObject.Find("PathPoint2");
		a.transform.position = new Vector3(1,1,1);
		controlPath[2] = a.transform as Transform;
		*/
	}
	...
	void DetectKeys(){
		...
		*/
		...
		float temps = pathPosition + (Time.deltaTime * speed);
		if(temps >= 1){
			Debug.Log(" reset ");
			Debug.Log(temps);
